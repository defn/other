...
objects: ServiceAccount: "cloudnative-pg": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
objects: ClusterRole: "cloudnative-pg": {
...
objects: ClusterRole: "cloudnative-pg-edit": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
objects: ClusterRole: "cloudnative-pg-view": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRole"
	metadata: {
		labels: {
...
objects: ClusterRoleBinding: "cloudnative-pg": {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
objects: ConfigMap: "cnpg-controller-manager-config": {
	apiVersion: "v1"
	data: {}
	kind: "ConfigMap"
	metadata: {
...
objects: ConfigMap: "cnpg-default-monitoring": {
	apiVersion: "v1"
	data: queries: """
		backends:
		  query: |
...
objects: Service: "cnpg-webhook-service": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
objects: Deployment: "cloudnative-pg": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
		...
		template: {
			...
			spec: {
				containers: [{
					...
					image:           "host.k3d.internal:5000/mirror/ghcr.io/cloudnative-pg/cloudnative-pg:1.29.1"
...
objects: MutatingWebhookConfiguration: "cnpg-mutating-webhook-configuration": {
...
objects: ValidatingWebhookConfiguration: "cnpg-validating-webhook-configuration": {
	apiVersion: "admissionregistration.k8s.io/v1"
