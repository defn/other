...
objects: CustomResourceDefinition: "analysisruns.argoproj.io": {
											...
											properties: {
													...
													properties: {
														...
														spec: {
															properties: {
																...
																podReplacementPolicy: type: "string"
																selector: {
																	properties: {
																		matchExpressions: {
																			items: {
																	...
																	properties: {
																		...
																		spec: {
																			properties: {
																						...
																						properties: {
																							...
																							resources: {
																								properties: {
																									...
																									limits: "x-kubernetes-preserve-unknown-fields":   true
																									requests: "x-kubernetes-preserve-unknown-fields": true
																								}
																								type: "object"
																							}
																							restartPolicy: type: "string"
																				...
																				volumes: "x-kubernetes-preserve-unknown-fields": true
																			}
																			required: ["containers"]
																			type: "object"
																		}
												...
												kayenta: {
													properties: {
														...
														canaryConfigName: type:         "string"
														configurationAccountName: type: "string"
														lookback: type:                 "boolean"
														metricsAccountName: type:       "string"
														scopes: {
															items: {
																properties: {
																	controlScope: {
...
objects: CustomResourceDefinition: "analysistemplates.argoproj.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: {
...
objects: CustomResourceDefinition: "clusteranalysistemplates.argoproj.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: {
...
objects: CustomResourceDefinition: "experiments.argoproj.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: {
...
objects: CustomResourceDefinition: "rollouts.argoproj.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: {
				...
				properties: {
					...
					spec: {
						properties: {
							...
							paused: type:                "boolean"
							progressDeadlineAbort: type: "boolean"
							progressDeadlineSeconds: {
								format: "int32"
								type:   "integer"
							}
								...
								properties: {
															...
															properties: {
																...
																valueFrom: {
																	properties: {
																		...
																		podTemplateHashValue: type: "string"
																	}
																	type: "object"
																}
															}
									...
									canary: {
										properties: {
											...
											dynamicStableScale: type: "boolean"
											maxSurge: {
												anyOf: [{
													type: "integer"
												}, {
											...
											pingPong: {
												properties: {
													pingService: type: "string"
													pongService: type: "string"
												}
												required: [
													"pingService",
													"pongService",
											...
											steps: {
												items: {
													properties: {
														...
														setCanaryScale: {
															properties: {
																matchTrafficWeight: type: "boolean"
																replicas: {
																	format: "int32"
																	type:   "integer"
																}
											...
											trafficRouting: {
												properties: {
														...
														properties: {
															destinationRule: {
																properties: {
																	...
																	canarySubsetName: type: "string"
																	name: type:             "string"
																	stableSubsetName: type: "string"
																}
																required: [
																	"canarySubsetName",
																	"name",
													...
													smi: {
														properties: {
															rootService: type:      "string"
															trafficSplitName: type: "string"
														}
														type: "object"
													}
													traefik: {
														properties: weightedTraefikServiceName: type: "string"
														required: ["weightedTraefikServiceName"]
														type: "object"
													}
												}
												type: "object"
						...
						properties: {
							...
							blueGreen: {
								properties: {
									...
									scaleUpPreviewCheckPoint: type: "boolean"
								}
								type: "object"
							}
							canary: {
							...
							controllerPause: type: "boolean"
							currentPodHash: type:  "string"
							currentStepHash: type: "string"
							currentStepIndex: {
								format: "int32"
								type:   "integer"
							}
							...
							stableRS: type: "string"
							updatedReplicas: {
								format: "int32"
								type:   "integer"
							}
							workloadObservedGeneration: type: "string"
						}
						type: "object"
					}
				}
