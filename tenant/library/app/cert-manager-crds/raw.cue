...
objects: CustomResourceDefinition: "certificaterequests.cert-manager.io": {
	...
	metadata: {
		...
		labels: {
			...
			"helm.sh/chart":                "cert-manager-v1.20.1"
		}
...
objects: CustomResourceDefinition: "certificates.cert-manager.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "helm.sh/resource-policy": "keep"
...
objects: CustomResourceDefinition: "challenges.acme.cert-manager.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "helm.sh/resource-policy": "keep"
...
objects: CustomResourceDefinition: "clusterissuers.cert-manager.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "helm.sh/resource-policy": "keep"
...
objects: CustomResourceDefinition: "issuers.cert-manager.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "helm.sh/resource-policy": "keep"
...
objects: CustomResourceDefinition: "orders.acme.cert-manager.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "helm.sh/resource-policy": "keep"
