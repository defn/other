...
objects: CustomResourceDefinition: "cloudeventsources.eventing.keda.sh": {
...
objects: CustomResourceDefinition: "clustercloudeventsources.eventing.keda.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.20.0"
...
objects: CustomResourceDefinition: "clustertriggerauthentications.keda.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.20.0"
	...
	"""
					...
					status: {
						...
						properties: {
							scaledjobs: type:    "string"
							scaledobjects: type: "string"
						}
						type: "object"
					}
				}
...
objects: CustomResourceDefinition: "scaledjobs.keda.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.20.0"
	...
	* While dataSource only allows local objects, dataSourceRef allows objects
	...
	"""
					...
					status: {
						...
						properties: {
							Paused: type:               "string"
							authenticationsTypes: type: "string"
							conditions: {
								description: "Conditions an array representation to store multiple Conditions"
								items: {
									description: "Condition to store the condition state"
							...
							triggersActivity: {
								additionalProperties: {
									description: "TriggerActivityStatus represents the activity status of an external trigger"
									properties: isActive: type: "boolean"
									type: "object"
								}
								type: "object"
							}
							triggersTypes: type: "string"
						}
						type: "object"
					}
				}
...
objects: CustomResourceDefinition: "scaledobjects.keda.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.20.0"
	...
	"""
					...
					status: {
						...
						properties: {
							authenticationsTypes: type: "string"
							compositeScalerName: type:  "string"
							conditions: {
								description: "Conditions an array representation to store multiple Conditions"
								items: {
									description: "Condition to store the condition state"
...
objects: CustomResourceDefinition: "triggerauthentications.keda.sh": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.20.0"
