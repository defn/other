...
import (
	...
	"github.com/defn/other/m/v/buildkite--agent/agent/plugin"
	"github.com/defn/other/m/v/buildkite--agent/api"
	"github.com/defn/other/m/v/buildkite--agent/env"
	"github.com/defn/other/m/v/buildkite--agent/internal/file"
	"github.com/defn/other/m/v/buildkite--agent/internal/job/hook"
	"github.com/defn/other/m/v/buildkite--agent/internal/osutil"
	"github.com/defn/other/m/v/buildkite--agent/internal/redact"
	"github.com/defn/other/m/v/buildkite--agent/internal/replacer"
	"github.com/defn/other/m/v/buildkite--agent/internal/secrets"
	"github.com/defn/other/m/v/buildkite--agent/internal/shell"
	"github.com/defn/other/m/v/buildkite--agent/internal/shellscript"
...
func (e *Executor) executeHook(ctx context.Context, hookCfg HookConfig) error {
	...
	spanName := fmt.Sprintf("%s %s hook", scopeName, hookCfg.Name)
