// Package model holds the canonical types, interfaces, and path/name
// normalization used across artifact-fs. Rules:
//
//   - CleanPath is the ONLY path-normalization function. Do not add
//     local wrappers.
//   - Do not reintroduce subset interfaces around snapshot, overlay,
//     hydrator, or gitstore access. Use the canonical model.* interfaces.
package model
