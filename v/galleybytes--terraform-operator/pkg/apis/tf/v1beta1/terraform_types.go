...
const (
	SetupTaskImageRepoDefault     = "host.k3d.internal:5000/devcontainer/dev"
	SetupTaskImageTagDefault      = "edge"
	TerraformTaskImageRepoDefault = "host.k3d.internal:5000/devcontainer/dev"
	TerraformTaskImageTagDefault  = ""
	ScriptTaskImageRepoDefault    = "host.k3d.internal:5000/devcontainer/dev"
	ScriptTaskImageTagDefault     = "edge"
)

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +genclient
// Tofu is the Schema for the terraforms API
// +kubebuilder:printcolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp"
// +k8s:openapi-gen=true
// +kubebuilder:storageversion
// +kubebuilder:subresource:status
// +kubebuilder:resource:singular=tofu,shortName=tf,path=tofus
type Tofu struct {
...
type TofuSpec struct {
	...
	// If not specified we create a new ServiceAccount per Tofu
	ServiceAccount string `json:"serviceAccount,omitempty"`

	// Credentials is an array of credentials generally used for Tofu
	// providers
...
type Images struct {
	...
	Tofu *ImageConfig `json:"terraform,omitempty"`
...
type Module struct {
	...
	// Tofu Operator prefers modules that are defined in a git repo as opposed to other scm types.
...
// For example, in AWS, the AWS Tofu Provider uses the default credential chain
...
type Credentials struct {
	...
	// for the Tofu AWS Provider. If using AWS_ACCESS_KEY_ID and/or environment
